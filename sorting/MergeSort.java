...
public class MergeSort {
    public static void main(String[] args) {
        int[] arr = { 68, 69, 93, 62, 52, 64, 22, 72, 71, 44, 33, 20, 76, 21, 92, 85, 48, 80, 50, 84, 6, 35, 32, 25, 54,
                3, 59, 77, 26, 89 };
        int n = arr.length;
        divide(arr, 0, n - 1);
    ...
    private static void conquer(int[] arr, int start, int mid, int end) {
        ...
        int j = mid + 1; // Pointer for second array
        int k = start; // Pointer for secondary array
